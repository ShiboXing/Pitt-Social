...
insert into profile (name, email, password, date_of_birth, lastlogin) values ('Alexandrie', 'alx@pitt.edu', 'apwd', '1995-08-21', '2019-10-10 16:00:00');
insert into profile (name, email, password, date_of_birth, lastlogin) values ('Panickos', 'pnk@pitt.edu', 'kpwd', '1997-09-08', '2019-10-11 15:00:00');
insert into profile (name, email, password, date_of_birth, lastlogin) values ('Socratis', 'soc@pitt.edu', 'spwd', '1991-05-17', '2019-10-11 16:00:00');
insert into profile (name, email, password, date_of_birth, lastlogin) values ('Yaw', 'yaw@pitt.edu', 'ypwd', '1997-02-27', '2019-10-12 15:00:00');
...
insert into groupInfo (name, size, description) values ('Grads at CS', 100, 'list of all graduate students');
insert into groupInfo (name, size, description) values ('DB Group', 10, 'members of the ADMT Lab');
...
insert into messageInfo (fromID, message, ToUserID, ToGroupID, timeSent) values (1, 'Are we meeting tomorrow for the project?', 2, NULL, '2019-12-01 15:00:00');
insert into messageInfo (fromID, message, ToUserID, ToGroupID, timeSent) values (1, 'Peters pub tomorrow?', 5, NULL, '2019-11-01 16:00:00');
insert into messageInfo (fromID, message, ToUserID, ToGroupID, timeSent) values (2, 'Please join our DB Group forum tomorrow', NULL, 1, '2019-10-10 15:00:00');
insert into messageInfo (fromID, message, ToUserID, ToGroupID, timeSent) values (5, 'Here is the paper I will present tomorrow', NULL, 2, '2019-10-10 16:00:00');
