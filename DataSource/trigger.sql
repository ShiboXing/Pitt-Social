...
/*
insert into profile
values(111,'Kirk','kk@ha.org','iii','1997-09-10');
insert into profile
values(112,'Kirk','kk@ha.org','iii','1997-09-10');
insert into profile
values(113,'Kirk','kk@ha.org','iii','1997-09-10');
call initiatefriendship(111,113,'poo poo');
call initiatefriendship(112,113,'poo poo');
select * from showFriendRequests(113);

call creategroup(111,'loo loo',100,'noo noo');
call creategroup(111,'loo loo',100,'noo noo');
insert into groupmember values(1,112,'not manager');
call initiateAddingGroup(112,2,'boo boo');
call initiateAddingGroup(113,1,'boo boo');
call initiateAddingGroup(113,2,'boo boo');
select * from showgrouprequests(111);*/
